...
@Component({
  selector: 'app-countermetric',
  templateUrl: './countermetric.component.html',
  styleUrls: ['./countermetric.component.css']
})
export class CountermetricComponent implements OnInit {
